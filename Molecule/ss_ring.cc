...
int
Substructure_Ring_Specification::debug_print (ostream & os,
...
int
Substructure_Ring_Specification::terse_details (ostream & os,
                                      const IWString & indentation) const
{
  IWString ind = indentation;
  ind += "  ";
...
Substructure_Ring_Specification::_environment_matches (Molecule_to_Match & target,
                                   const Ring & r)
{
  int * tmp = new_int (target.natoms ()); iw_auto_array<int> free_tmp (tmp);
