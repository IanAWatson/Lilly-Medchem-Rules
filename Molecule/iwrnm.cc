...
//  C1(=C/N(C)C)/C(=O)NN=C1            OK
//  C1(=C/N(C)C)/C(=O)NN=C/1           Corina complains incomplete specification and ignores
//  C1(=C/N(C)C)/C(=O)NN=C\1           Corina complains inconsistent and fails
